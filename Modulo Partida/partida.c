...
$FV Valor retornado
	...
	CondRetPonteiroNulo    - a função recebeu um ponteiro nulo
...
$FV Valor retornado
	PAR_CondRetPonteiroNulo - a função recebeu um ponteiro nulo
...
$EV Valor Retornado
	...
	Retorna o índice correspondente ao jogador que começa ou -1 quando recebe um ponteiro nulo
